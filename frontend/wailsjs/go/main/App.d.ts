...
export function CheckProjectSetup(arg1:string):Promise<services.ProjectSetupStatus>;
...
export function RunProjectSetup(arg1:string,arg2:services.SetupAction):Promise<void>;
