...
function TeamSubAgentNodeComponent({ data }: { data: TeamSubAgentNodeData }) {
  return (
    <>
      ...
      <div className="flex items-center gap-2 px-4 py-3 rounded-lg border border-zinc-700 bg-zinc-800 min-w-[160px]">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-[10px] text-zinc-500 truncate">{data.model}</p>
        </div>
      </div>
